            ...
            <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div id="profile"
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div
                            className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center overflow-hidden">
                            <img src={MajdPicture} alt="Majd" className="object-cover"/>
                        </div>
                ...
                <div className="absolute top-0 right-0 h-12 w-18 p-4">
                    <button className="js-change-theme focus:outline-none"><span role="img" aria-label="moon">🌙</span></button>
                </div>
