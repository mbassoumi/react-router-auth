...
const Dashboard = () => {
    ...
    useEffect(() => {
        if (auth.user.loggedFrom === 'facebook') {
            setUserPicture(`//graph.facebook.com/${auth.user.id}/picture?type=large`);
        } else if (auth.user.loggedFrom === 'google') {
            setUserPicture(auth.user.picture);
        }
            ...
            <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div id="profile"
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div
                            className="block rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center overflow-hidden">
                            <img src={userPicture} alt="Majd" width='1000'
                                 className="object-cover object-fill"/>
                        </div>

                        <h1 className="text-3xl font-bold pt-8 lg:pt-0">{auth.user.displayName}</h1>
                        ...
                        <p className="pt-8 text-sm">Dummy page to display user info</p>
                ...
                <div className="absolute top-0 right-0 h-12 w-18 p-4">
                    <button className="js-change-theme focus:outline-none"><span role="img" aria-label="moon">🌙</span>
                    </button>
                </div>
