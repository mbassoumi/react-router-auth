            ...
            <div className="w-full container mx-auto p-6">
                ...
                <div className="w-full flex items-center justify-between">
                    ...
                    <div className="flex w-1/2 justify-end content-center text-blue-400">
                            <Link to="/login" className="mx-2 px-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2  rounded focus:outline-none focus:shadow-outline">Login</Link>
                            <Link to="/signup" className="mx-2 px-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2  rounded focus:outline-none focus:shadow-outline">Signup</Link>
                    </div>
            ...
            <div className="container pt-24 md:pt-32 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                    ...
                    <div className="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                        <img src={AppStoreSvg} className="h-12 pr-4 bounce-top-icons"/>
                        <img src={PlayStoreSvg} className="h-12 bounce-top-icons"/>
                    </div>
                ...
                <div className="w-full xl:w-3/5 py-6 overflow-y-hidden">
                    <img className="w-5/6 mx-auto lg:mr-0 slide-in-bottom" src={DevicesSvg}/>
                </div>
